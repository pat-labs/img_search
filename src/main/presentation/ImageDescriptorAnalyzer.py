...
class ImageDescriptorAnalyzer:
    ...
    def _make_report(image_name: str, image_statistics: List[ImageDescriptorStatistic]) -> str:
        ...
        separator = "|---|---|---|---|---|---|\n"
        rows = [
            f"| {stat.algorithm} | {stat.variant} | {stat.match_ratio:.2f} | {stat.avg_distance:.2f} | {stat.memory_usage_mb:.4f} | {stat.execution_time_seconds:.6f} |"
    ...
    def analyze_image_descriptors(image_path: str, variant_files: List[str]) -> str:
        ...
        for descriptor_type in DescriptorType:
            ...
            try:
                ...
                keypoints1, descriptors1 = features1.keypoints, features1.descriptor
                ...
                for file_path in variant_files:
                    ...
                    keypoints2, descriptors2 = features2.keypoints, features2.descriptor
...
if __name__ == '__main__':
    ...
    image_path = base_path + "dataset/test/Image_1.jpg"
    transform_dir = base_path + "dataset/variance/"
