...
from PanoramaStitching import stitch_two_images
...
def main():
    ...
    japan1 = cv.imread("project_images/Japan1.jpg")
    japan2 = cv.imread("project_images/Japan2.jpg")
    japan3 = cv.imread("project_images/Japan3.jpg")
    bonus2_stitch_japan(
        japan1,
        japan2,
        japan3,
...
def stitch_rainier(rainier1, rainier2, ransacIterations, ransacThreshold):
    ...
    cv.imwrite(
        Rainier1_2_file_path, stitched_image
    )  # Save Rainier1 and Rainier 2 Stitched to project_images/4.png
    ...
    for i in range(3, 7):  # We want to load Rainier 3-6
        ...
        stitched_image = stitch_two_images(
            ...
            siftFilePath="",
            saveSiftMatches=False,
            ransacDisplayName="{}. RANSAC Matches for R1-{} and Rainier{} (R1-{}) ".format(
                i + 2, i - 1, i, i
            ),
    ...
    cv.imshow(
        "9. Stitched Rainier1-6 (Scaled 50% for Displaying) (src/project_images/output5.png)",
        stitched_image,
    )
    cv.waitKey(0)
    cv.destroyAllWindows()
...
def bonus2_stitch_japan(japan1, japan2, japan3, ransacIterations, ransacThreshold):
    jp1_jp2_stitched = stitch_two_images(
        japan1,
        japan2,
        siftDisplayName="",
        siftFilePath="",
    ...
    jp_all_stitched = stitch_two_images(
        jp1_jp2_stitched,
        japan3,
        siftDisplayName="",
        siftFilePath="",
